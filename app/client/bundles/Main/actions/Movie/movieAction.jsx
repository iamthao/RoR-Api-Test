...
//Next sentence
export const onClickNextSentence = (value) => {
    return { type: 'ON_CLICK_NEXT_SENTENCE'}
};


export default { fetchNewMovie, requestedMovie, requestedMovieSucceeded, requestedMovieFailed,
    movieSetSentenceToLearn,onChangeTextAnswerInput, onClickCheckAnswer,
    onClickNextSentence, errorNotInputAnswer }
